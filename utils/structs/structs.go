...
type ConfigSet struct {
	...
	// WebSocket settings
	WebSocketPort     string `yaml:"websocket-port"`
	ZipPath           string `yaml:"zip-path"`
	S3Endpoint        string `yaml:"s3-endpoint"`
	S3AccessKeyID     string `yaml:"s3-access-key"`
	S3SecretAccessKey string `yaml:"s3-secret-key"`
	S3Bucket          string `yaml:"s3-bucket"`
	S3Region          string `yaml:"s3-region"`
	CDNUrl            string `yaml:"cdn-url"`
}
